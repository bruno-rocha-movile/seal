...
class SlackPoster
  ...
  def assign_poster_settings
    if @mood == "informative"
      @mood_hash[:icon_emoji]= ":#{@season_symbol}prbot:"
      @mood_hash[:username]= "#{@season_name}prbot"
    elsif @mood == "approval"
      @mood_hash[:icon_emoji]= ":#{@season_symbol}prbot:"
      @mood_hash[:username]= "#{@season_name}prbot"
    elsif @mood == "angry"
      @mood_hash[:icon_emoji]= ":#{@season_symbol}angry_prbot:"
      @mood_hash[:username]= "#{@season_name}Angry prbot"
    elsif @mood == "tea"
